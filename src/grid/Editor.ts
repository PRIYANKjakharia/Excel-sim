...
export class Editor {
    ...
    constructor( container: HTMLElement, dataStore: GridDataStore, commandManager: CommandManager, onSave: () => void ){
    ...
    public show( row: number, column: number, x: number,y: number,width: number = GridConfig.COLUMN_WIDTH, height: number = GridConfig.ROW_HEIGHT ): void{
        this.row = row;
        this.column = column;
        this.isSaving = false;
