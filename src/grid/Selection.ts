...
export class Selection {
    ...
    private activeCell: CellPosition = { row: 0, column: 0 };

    private selectionType: SelectionType = SelectionType.CELL;
    ...
    public selectRow(row: number): void{
        ...
        this.selectedRange ={
            start: { row, column: 0 },
            end: { row, column: Number.MAX_SAFE_INTEGER }
        };
    ...
    public selectColumn(column: number): void {
        ...
        this.selectedRange = {
            start: {row: 0, column},
            end: { row: Number.MAX_SAFE_INTEGER,column }
        };
